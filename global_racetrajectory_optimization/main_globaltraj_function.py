...
"""
def get_beast_map(filename, start_x, start_y): #, start_angle, start_velocity, start_acceleration, start_jerk, start_snap, start_time):
    # ----------------------------------------------------------------------------------------------------------------------
    # USER INPUT -----------------------------------------------------------------------------------------------------------
    # ----------------------------------------------------------------------------------------------------------------------
    ...
    # file_paths["track_name"] = "ThruxtonOfficial"                                    # Berlin Formula E 2018
    file_paths["track_name"] = filename
    ...
    imp_opts = {"flip_imp_track": False,                # flip imported track to reverse direction
                ...
                "new_start": np.array([start_x, start_y]),    # [x_m, y_m]
